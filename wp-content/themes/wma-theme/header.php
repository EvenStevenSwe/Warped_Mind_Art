                    ...
                    <div class="wma-container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?php echo get_page_link( get_page_by_title( Shop )->ID ); ?>">Beställning</a></li>
                                <li><a href="<?php echo get_page_link( get_page_by_title( Varukorg )->ID ); ?>">Varukorg</a></li>
                            </ul>
