...
if ( ! class_exists( 'Storefront_WooCommerce' ) ) :
	...
	class Storefront_WooCommerce {
		...
		public function woocommerce_scripts() {
			...
			wp_enqueue_style( 'storefront-woocommerce-style', get_template_directory_uri() . '/assets/scss/woocommerce/woocommerce.css', array(), $storefront_version );
		...
		public function woocommerce_integrations_scripts() {
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Bookings' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-bookings-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/bookings.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Brands' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-brands-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/brands.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Wishlists_Wishlist' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-wishlists-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/wishlists.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'SOD_Widget_Ajax_Layered_Nav' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-ajax-layered-nav-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/ajax-layered-nav.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_SwatchesPlugin' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-variation-swatches-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/variation-swatches.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Composite_Products' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-composite-products-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/composite-products.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Photography' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-photography-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/photography.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Product_Reviews_Pro' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-product-reviews-pro-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/product-reviews-pro.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Smart_Coupons' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-smart-coupons-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/smart-coupons.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Deposits' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-deposits-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/deposits.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Bundles' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-bundles-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/bundles.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Ship_Multiple' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-sma-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/ship-multiple-addresses.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'Woocommerce_Advanced_Product_Labels' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-apl-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/advanced-product-labels.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Mix_and_Match' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-mix-and-match-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/mix-and-match.css', 'storefront-woocommerce-style' );
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Quick_View' ) ) {
				wp_enqueue_style( 'storefront-woocommerce-quick-view-style', get_template_directory_uri() . '/assets/scss/woocommerce/extensions/quick-view.css', 'storefront-woocommerce-style' );
