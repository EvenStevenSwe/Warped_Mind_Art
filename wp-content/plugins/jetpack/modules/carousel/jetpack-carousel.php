...
class Jetpack_Carousel {
	...
	function init() {
		...
		if ( $this->in_jetpack && method_exists( 'Jetpack', 'module_configuration_load' ) ) {
			Jetpack::enable_module_configurable( dirname( dirname( __FILE__ ) ) . '/slider.php' );
			Jetpack::module_configuration_load( dirname( dirname( __FILE__ ) ) . '/slider.php', array( $this, 'jetpack_configuration_load' ) );
		}
	}
	...
	function post_attachment_comment() {
		...
		/** This action is documented in modules/carousel/jetpack-slider.php */
		do_action('jp_carousel_check_blog_user_privileges');
