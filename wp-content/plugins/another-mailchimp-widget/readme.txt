...
Tags: newsletter, mailchimp, mailchimp widget, mailchimp subscribe, mailchimp shortcode, mailchimp groups
...
* placeholder - true or false; set true to display filed labels as placeholders;
